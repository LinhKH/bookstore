<?php 
	...
	$orderPost		= isset($this->arrParam['filter_column_dir'] ) ? $this->arrParam['filter_column_dir'] : '';
	...
	$selectboxSpecial	= Helper::cmsSelectbox('filter_special', 'inputbox', $arrSpecial, isset($this->arrParam['filter_special']) ? $this->arrParam['filter_special'] : '' );
	
	// CATEGORY
	$selectboxCategory	= Helper::cmsSelectbox('filter_category_id', 'inputbox', $this->slbCategory, isset($this->arrParam['filter_category_id']) ? $this->arrParam['filter_category_id'] : '' );
