<?php 
	...
	$inputUserName	= Helper::cmsInput('text', 'form[username]', 'username', isset($dataForm['username']) ? $dataForm['username'] : '', 'inputbox required', 40);
	$inputEmail		  = Helper::cmsInput('text', 'form[email]', 'email', isset($dataForm['email']) ? $dataForm['email'] : '', 'inputbox required', 40);
	$inputFullName	= Helper::cmsInput('text', 'form[fullname]', 'fullname', isset($dataForm['fullname']) ? $dataForm['fullname'] : '', 'inputbox', 40);
	$inputPassword	= Helper::cmsInput('text', 'form[password]', 'password', isset($dataForm['password']) ? $dataForm['password'] : '', 'inputbox required', 40);
