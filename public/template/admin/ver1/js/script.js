...
var GENERAL = {
    ...
    checkPanelIsCollapsed: function () {
    ...
    checkCommentIsCollapsed: function () {
        $(".comment-custom").click(function () {
            var flag = $(this).parents(".comment-main").next().is(":visible");
            if (flag === true) {
                $(this).find("i").removeClass("fa-caret-up");
                $(this).find("i").addClass("fa-caret-down");
            } else {
...
$(document).ready(function () {
    ...
    GENERAL.checkPanelIsCollapsed();
    GENERAL.checkCommentIsCollapsed();
